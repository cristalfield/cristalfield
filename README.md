...
<img
  src="https://cr-ss-service.azurewebsites.net/api/ScreenShot?widget=work-experience&username=cristalfield&max-items=2&logos=true&style=--item-bg-color:GrayGoose;--item-border-radius:10px"
/>
